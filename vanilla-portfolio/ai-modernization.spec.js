...
test.describe('Portfolio Modernization Tests', () => {
  ...
  test('Experience section should quantify impact with seniority metrics', async ({ page }) => {
    ...
    expect(labels).toContain('Years Legacy Modernization');
    expect(labels).toContain('Production Releases Led');
    expect(labels).toContain('Associate Developers Mentored');
  });
  ...
  test('Bento grid should highlight Optimization and Security', async ({ page }) => {
